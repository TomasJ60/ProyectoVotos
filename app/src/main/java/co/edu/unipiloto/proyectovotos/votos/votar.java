...
import android.location.Geocoder;
import android.location.Address; // Asegúrate de importar esto
import java.util.List;

public class votar extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mapFragment != null) {
            mapFragment.getMapAsync(votar.this);
        }

        btnConfirmarPuesto = findViewById(R.id.btnConfirmarPuesto);
        btnConfirmarPuesto.setOnClickListener(view -> {
            if (puestoSeleccionado != null) {
                Intent intent = new Intent(votar.this, VerPropuestasdelocalidades.class);
                intent.putExtra("puestoSeleccionado", puestoSeleccionado);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(marker -> {
            puestoSeleccionado = marker.getTitle();  // Guardar el puesto seleccionado
