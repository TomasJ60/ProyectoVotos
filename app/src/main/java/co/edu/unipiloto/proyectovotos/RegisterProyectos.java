...
public class RegisterProyectos extends AppCompatActivity {
    ...
    private TextInputLayout addressLayout; // Usamos TextInputLayout
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(RegisterProyectos.this, "Usuario creado", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(RegisterProyectos.this, "Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
